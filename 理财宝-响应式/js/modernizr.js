...
! function(e, n, s) {
    ...
    var i = [],
        ...
        f = {
            ...
            addTest: function(e, n, s) { l.push({ name: e, fn: n, options: s }) },
    ...
    Modernizr.addTest("svg", !!n.createElementNS && !!n.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect), a(), t(i), delete f.addTest, delete f.addAsyncTest;
